# [Command] _network network-watcher packet-capture delete_
...
- Delete packet capture
    ```bash
        network network-watcher packet-capture delete --resource-group rg1 --network-watcher-name nw1 --packet-capture-name pc1
    ```
