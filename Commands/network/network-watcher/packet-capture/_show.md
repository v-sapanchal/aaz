# [Command] _network network-watcher packet-capture show_
...
- Get packet capture
    ```bash
        network network-watcher packet-capture show --resource-group rg1 --network-watcher-name nw1 --packet-capture-name pc1
    ```
